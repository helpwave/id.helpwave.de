...
export type HelpwaveIdTranslationEntries = {
  ...
  'profilePictureUploadFailed': string,
  'profilePictureUploading': string,
  'profilePictureWrongType': string,
  'realmBannerAdmin': string,
  'realmBannerOther': string,
  'realmBannerSubtitleAdmin': string,
  'realmBannerSubtitleOther': string,
  'realmBannerSubtitleTeam': string,
  'realmBannerTeam': string,
...
export const helpwaveIdTranslation: Translation<HelpwaveIdTranslationLocales, Partial<HelpwaveIdTranslationEntries>> = {
  'de-DE': {
    ...
    'captchaFailed': `Captcha-Prüfung fehlgeschlagen. Bitte versuchen Sie es erneut.`,
    ...
    'privacy': `Datenschutz`,
    'privacyPolicy': `Datenschutzerklärung gelesen und akzeptiere sie`,
    ...
    'profilePictureHelp': `JPEG, PNG oder WebP, max. 5 MB. Das Bild wird skaliert und sicher gespeichert.`,
    'profilePictureTooLarge': `Die gewählte Datei ist größer als 5 MB.`,
    'profilePictureUploadFailed': `Upload fehlgeschlagen. Bitte erneut versuchen.`,
    'profilePictureUploading': `Wird hochgeladen…`,
    'profilePictureWrongType': `Nur JPEG, PNG oder WebP werden unterstützt.`,
    'realmBannerAdmin': `Administrator-Portal`,
    'realmBannerOther': `Internes Realm`,
    'realmBannerSubtitleAdmin': `Administrativer Zugriff – jede Aktion wird protokolliert.`,
    'realmBannerSubtitleOther': `Dies ist nicht der reguläre Kunden-Login.`,
    'realmBannerSubtitleTeam': `Sie melden sich in einem privilegierten Team-Bereich an.`,
    'realmBannerTeam': `Team-Arbeitsbereich`,
    'recoveryAuthnCodeConfigMessage': `Konfigurieren Sie Ihren Wiederherstellungsauthentifizierungscode`,
    'recoveryCode': `Wiederherstellungscode`,
    'register': `Registrieren`,
    'rememberMe': `Angemeldet bleiben`,
    'removeProfilePicture': `Bild entfernen`,
...
Der Anmeldevorgang wird von vorne begonnen.`,
    ...
    'uploadProfilePicture': `Bild hochladen`,
  ...
  'en-US': {
    ...
    'profilePictureHelp': `JPEG, PNG or WebP, max. 5 MB. The image is scaled and stored securely.`,
    'profilePictureTooLarge': `The selected file is larger than 5 MB.`,
    'profilePictureUploadFailed': `Upload failed. Please try again.`,
    'profilePictureUploading': `Uploading…`,
    'profilePictureWrongType': `Only JPEG, PNG or WebP images are supported.`,
    'realmBannerAdmin': `Administrator portal`,
    'realmBannerOther': `Internal realm`,
    'realmBannerSubtitleAdmin': `Administrative access — every action is audited.`,
    'realmBannerSubtitleOther': `This is not the regular customer login.`,
    'realmBannerSubtitleTeam': `You are signing in to a privileged team area.`,
    'realmBannerTeam': `Team workspace`,
